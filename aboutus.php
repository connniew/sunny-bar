...
<body>
    ...
    <main class="main-content">
        ...
        <section class="card">
            ...
            <img class="card__image" src="images/top-photo.jpg" alt="Bette Davis eating ice cream">
        </section>
        ...
        <section class="card card--reverse">
            ...
            <img class="card__image" src="images/middle-photo.jpg" alt="Marilyn Monroe eating ice cream">
        </section>
        ...
        <section class="card">
            ...
            <img class="card__image" src="images/bottom-photo.jpg" alt="Marilyn Monroe eating ice cream">
        </section>
