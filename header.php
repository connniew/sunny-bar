...
<head>
    ...
    <!-- css -->
    <link rel="stylesheet" href="styles/global.css?<?php echo time(); ?>">
    <link rel="stylesheet" href="styles/navbar.css?<?php echo time(); ?>">
    <link rel="stylesheet" href="styles/footer.css?<?php echo time(); ?>">
